# Consulta Portal Transparência - Informaçoes de contratos segurança
...
```
https://github.com/brunorreiss/transparencia-informacoes-contratos-seguranca
```
2. Mude de diretorio:
```
cd transparencia-informacoes-contratos-seguranca
```
