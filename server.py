...
logger_name = env.get('BOT_NAME', default='transparencia-informacoes-contratos-seguranca')
...
tags_metadata = [
    {
        'name': 'transparencia-informacoes-contratos-seguranca',
        'description': 'Consulta Portal Tranparencia Fortaleza - informacoes contratos segurança'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - informacoes contratos segurança', 
    description=desc, 
    debug=False, 
    openapi_tags=tags_metadata,
    openapi_url="/api/transparencia-informacoes-contratos/consulta/docs/openapi.json",
    docs_url='/api/transparencia-informacoes-contratos/consulta/docs'
)
...
#---------------------------- Endpoints -------------------------------
@app.get(
    path="/api/transparencia-informacoes-contratos/consulta", 
    tags=['transparencia-informacoes-contratos'],
    responses=responses)
async def get_consulta(ano: str = ano_requerido,
                       orgao: models.Orgao = None):    
    return await consulta.fetch(ano, orgao)
